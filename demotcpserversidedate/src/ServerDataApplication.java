...
public class ServerDataApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		ServerDataGenerator dateGenerator = new ServerDataGenerator();
		...
		while (true) {
			...
			dateGenerator.setCurrentDate(serverFrame.GetInputFromGui);
			dateGenerator.setNoOFWordsInAString(serverFrame.GetInputFromGui);
			...
			// Send current date back to the client
		     outputStream.writeBytes(dateGenerator.getCurrentDate());
			
			outputStream.writeBytes(dateGenerator.getNoOFWordsInAString());
			...
			serverFrame.updateRequestStatus(
					"Data sent to the client: " + dateGenerator.getCurrentDate()+"\nAnd Number of Words ="+dateGenerator.getNoOFWordsInAString());
